...
<asp:Content ID="Content2" runat="server" contentplaceholderid="ContentPlaceHolder1">
    ...
    <div id="createCourseModal" runat="server" class="modal-overlay" style="visibility: hidden;">
        <div class="modal-box">
    ...
    <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:ReadCardDB %>"
        SelectCommand="SELECT TOP 3 * FROM [Course] ORDER BY [CourseCreatedDate] DESC">
    </asp:SqlDataSource>
...
"></asp:SqlDataSource>
    ...
    <asp:SqlDataSource ID="courseCreationTrend" runat="server"
        ...
        SelectCommand="SELECT * FROM [Course] ORDER BY [CourseCreatedDate] DESC"></asp:SqlDataSource>
