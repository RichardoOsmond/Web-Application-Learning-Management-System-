...
<head runat="server">
    <title>Forgot Password – Read Card Do Learn</title>
    <meta charset="utf-8" />
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; font-family: Arial, sans-serif; }
        ...
        .msg-area { text-align: center; font-size: 14px; margin-bottom: 15px; display: block; font-weight: bold; padding: 5px; }
        ...
        <div class="right-panel">
            ...
            <div class="form-container">
                ...
                <asp:Panel ID="pnlStep1" runat="server" Visible="true">
                    <p class="form-subtitle">Enter your registered email address to verify your account.</p>
                    <asp:Label ID="lblStep1Msg" runat="server" Visible="false" CssClass="msg-area msg-error"></asp:Label>
                    <div class="form-row">
                        <label>Email Address:</label>
                        <asp:TextBox ID="txtEmail" runat="server" TextMode="Email" placeholder="e.g. robin@mail.com" />
                    </div>
                    <div class="validator-row">
                        <asp:RequiredFieldValidator ID="rfvEmail" runat="server" ControlToValidate="txtEmail" ErrorMessage="Email is required." ForeColor="Red" Display="Dynamic" Font-Size="12px" ValidationGroup="vgStep1" />
                    </div>
                    <asp:Button ID="btnVerify" runat="server" Text="Verify Email" CssClass="btn-enter" OnClick="btnVerify_Click" ValidationGroup="vgStep1" />
                </asp:Panel>

                <asp:Panel ID="pnlStep2" runat="server" Visible="false">
                    <p class="form-subtitle">Please create a new strong password for your account.</p>
                    <asp:Label ID="lblStep2Msg" runat="server" Visible="false"></asp:Label>
                    <div class="form-row">
                        <label>New Password:</label>
                        <asp:TextBox ID="txtNewPassword" runat="server" TextMode="Password" placeholder="Minimum 6 characters" />
                    </div>
                    <div class="validator-row">
                        <asp:RequiredFieldValidator ID="rfvNewPwd" runat="server" ControlToValidate="txtNewPassword" ErrorMessage="New password is required." ForeColor="Red" Display="Dynamic" Font-Size="12px" ValidationGroup="vgStep2" />
                        <asp:RegularExpressionValidator ID="revNewPwd" runat="server" ControlToValidate="txtNewPassword" ValidationExpression=".{6,}" ErrorMessage="Minimum 6 chars required." ForeColor="Red" Display="Dynamic" Font-Size="12px" ValidationGroup="vgStep2" />
                    </div>
                    <div class="form-row">
                    ...
                    <div class="validator-row">
                        <asp:RequiredFieldValidator ID="rfvConfirmPwd" runat="server" ControlToValidate="txtConfirmPassword" ErrorMessage="Please confirm password." ForeColor="Red" Display="Dynamic" Font-Size="12px" ValidationGroup="vgStep2" />
                        <asp:CompareValidator ID="cvPwd" runat="server" ControlToValidate="txtConfirmPassword" ControlToCompare="txtNewPassword" ErrorMessage="Passwords do not match." ForeColor="Red" Display="Dynamic" Font-Size="12px" ValidationGroup="vgStep2" />
                    </div>
                    <asp:Button ID="btnReset" runat="server" Text="Update Password" CssClass="btn-enter" OnClick="btnReset_Click" ValidationGroup="vgStep2" />
                </asp:Panel>
            </div>
        </div>
    </div>
